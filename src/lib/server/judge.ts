...
import { lookupCards, type Card } from './cards.ts';
...
1. Basa la risposta SOLO sulle Comprehensive Rules e sui testi delle carte forniti nel contesto. Non inventare regole né testi di carte.
2. Cita sempre i numeri di regola pertinenti (es. "509.1a", "702.2b") tra parentesi. I numeri e i nomi delle regole restano in inglese.
